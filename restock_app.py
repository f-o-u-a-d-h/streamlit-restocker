...
with st.form("restock_form"):
    ...
    outpatient = st.number_input("Outpatient Visits", min_value=0, value=10)
    emergency = st.number_input("Emergency Visits", min_value=0, value=5)
    inpatient = st.number_input("Inpatient Visits", min_value=0, value=2)
    consumed = st.number_input("Medicine Consumed", min_value=0, value=100)
    in_stock = st.number_input("Stock Remaining", min_value=0, value=50)
